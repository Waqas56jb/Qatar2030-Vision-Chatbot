...
const MessageList = ({ messages, isLoading }) => {
  return (
    <div className="h-full overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-accent-gold/30 scrollbar-track-gray-100">
      {messages.length === 0 ? (
        <div className="h-full flex items-center justify-center">
          ...
          <div className="flex flex-wrap gap-3 justify-center mt-4">
            <span className="px-4 py-2 bg-accent-gold/20 text-black rounded-full text-sm font-medium">Four Pillars</span>
            <span className="px-4 py-2 bg-accent-gold/20 text-black rounded-full text-sm font-medium">NDS Strategies</span>
            <span className="px-4 py-2 bg-accent-gold/20 text-black rounded-full text-sm font-medium">QNV 2030</span>
          </div>
          </div>
        </div>
      ) : (
